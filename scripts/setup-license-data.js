...
async function setupLicenseData() {
  try {
    console.log('🚀 Setting up license data in Supabase...');
    ...
    if (typesError) {
      console.log('⚠️ License types might already exist, continuing...');
    } else {
      console.log(`✅ Created ${insertedTypes.length} license types`);
    }

    // Get license types for foreign keys
    ...
    // Create requirements
    console.log('📝 Creating license requirements...');
    const requirements = [
    ...
    // Create pricing
    console.log('📝 Creating license pricing...');
    const pricing = [
    ...
    // Create procedures
    console.log('📝 Creating license procedures...');
    const procedures = [
      {
    ...
    console.log('🎉 License data setup completed!');
    console.log('\n📋 Created data:');
    ...
    console.error('❌ Error setting up license data:', error);
    process.exit(1);
  }
}
